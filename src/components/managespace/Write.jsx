        ...
        <section className='flex flex-col items-start w-full gap-2'>
            <div className='flex items-start justify-start gap-2'>
                ...
                <h2 className='font-bold w-full text-black dark:text-white duration-300 ease-in-out'>
                    Write content for the file - {fileDetails.name}
                </h2>
            </div>
                            ...
                            {support ?
                                <div className='flex gap-1 items-start'>
                                    ...
                                    <span className='text-[0.8rem] text-[#4C4C4C] dark:text-[#c4c4c4] duration-300 ease-in-out'>
                                        Writer is supported in your browser.
                                    </span>
                                </div>
                                :
                                <div className='flex gap-1 items-start'>
                                    ...
                                    <span className='text-[0.8rem] text-[#4C4C4C] dark:text-[#c4c4c4] duration-300 ease-in-out'>
                                        Writer is not supported in your browser.
                                    </span>
                                </div>
                            }
                        </div>
                            ...
                            <div>
                                {available ?
                                    <div className='flex gap-1 items-start'>
                                        ...
                                        <span className='text-[0.8rem] text-[#4C4C4C] dark:text-[#c4c4c4] duration-300 ease-in-out'>
                                            Writer is available in your browser.
                                        </span>
                                    </div>
                                    :
                                    support ?
                                    <div className='flex gap-1 items-start'>
                                        ...
                                        <span className='text-[0.8rem] text-[#4C4C4C] dark:text-[#c4c4c4] duration-300 ease-in-out'>
                                            Writer is supported but not available in your browser.
                                        </span>
                                    </div>
                                    :
                                    <div className='flex gap-1 items-start'>
                                        ...
                                        <span className='text-[0.8rem] text-[#4C4C4C] dark:text-[#c4c4c4] duration-300 ease-in-out'>
                                            Writer is neither supported nor available in your browser.
                                        </span>
                                    </div>
                                }
                            </div>
